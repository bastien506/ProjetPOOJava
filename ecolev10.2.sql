...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 30 mai 2019 à 21:57
...
(2006, 'Excellent', 11001, 8004),
(2007, '.', 11002, 8004),
(2008, 'Continue comme ça.', 11001, 8005),
(2009, 'Assez bien', 11001, 8006),
(2010, 'Tres bien', 11001, 8007),
(2011, 'Assez bien', 11001, 8008),
...
CREATE TABLE IF NOT EXISTS `inscription` (
  ...
  KEY `ID_classe` (`ID_classe`)
) ENGINE=InnoDB AUTO_INCREMENT=8108 DEFAULT CHARSET=latin1;
